...
export const CATEGORY_THEME = {
  ...
  activation: { light: "#c0392b", dark: "#ef5350" },
  normalization: { light: "#00695c", dark: "#26a69a" },
  pooling: { light: "#6a1b9a", dark: "#ab47bc" },
  reshape: { light: "#546e7a", dark: "#90a4ae" },
  math: { light: "#7b1fa2", dark: "#ce93d8" },
  reduction: { light: "#0277bd", dark: "#64b5f6" },
  merge: { light: "#5c6bc0", dark: "#9fa8da" },
