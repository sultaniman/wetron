...
<style>
  ...
  :global([data-theme='dark']) .chip[data-type='bool'] {
  ...
  :global([data-theme='dark']) .chip[data-type='float'] {
  ...
  :global([data-theme='dark']) .chip[data-type='tensor'] {
    background: rgba(76, 175, 80, 0.13);
    color: #4caf50;
  }
  :global([data-theme='dark']) .chip[data-type='optional'],
  :global([data-theme='dark']) .chip[data-type='[]'] {
