...
<div class="inspector" data-testid="quantization-inspector">
  {#if !result}<div class="inspector-note">
      ...
      <div class="inspector-control">
        <span class="inspector-caption">block <Hint text={quantizationHint('block', result, block)} /></span><span
          class="inspector-bounded"
          ><input
    ...
    <div class="inspector-plot">
      ...
      <div class="inspector-chart-axis">
        <span>code 0</span><span>code 8 · zero <Hint text={quantizationHint('histogram', result, block)} /></span><span
          >code {result.frequencies.length - 1}</span
        >
      </div>
    </div>
    <div class="inspector-stats">
      <span class="inspector-stat"
        ><span class="inspector-stat-label">format <Hint text={quantizationHint('format', result, block)} /></span><span
          class="inspector-stat-value"
          data-testid="quantization-format">{result.dtype}</span
        ></span
      ><span class="inspector-stat"
        ><span class="inspector-stat-label">levels used <Hint text={quantizationHint('levels', result, block)} /></span
      ...
      ><span class="inspector-stat"
        ...
        ><span class="inspector-stat-value" data-testid="quantization-blockSize">{result.valuesPerBlock}</span></span
      ><span class="inspector-stat"
        ><span class="inspector-stat-label"
          >trailing bytes <Hint text={quantizationHint('trailingBytes', result, block)} /></span
        ><span class="inspector-stat-value" data-testid="quantization-trailingBytes">{result.trailingBytes}</span></span
      >{#if block}<span class="inspector-stat"
          ><span class="inspector-stat-label">scale <Hint text={quantizationHint('scale', result, block)} /></span><span
            class="inspector-stat-value"
            data-testid="quantization-scale">{formatVal(block.scale, 'float32')}</span
          ></span
        ><span class="inspector-stat"
          ><span class="inspector-stat-label"
        ...
        ><span class="inspector-stat"
          ...
          ><span class="inspector-stat-value" data-testid="quantization-zeroCode">{block.zeroCodeFrequency}</span></span
        >{/if}
    </div>{/if}
</div>
