...
- [git-history-reorg.md](git-history-reorg.md) - Squash ~100 fine-grained commits into ~20 logical groups via interactive rebase. Status: proposed.
- [svelte-weight-panel-port.md](svelte-weight-panel-port.md) - Hoist `format-val` / `heatmap-color` into `@wetron/core`; port React `WeightPanel` family to Svelte. Status: proposed.
