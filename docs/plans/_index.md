...
- [headless-react-composition.md](headless-react-composition.md) - React provider and hooks for model loading, selection, and weight inspection without prescribed UI. Status: proposed.
