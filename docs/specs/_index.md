...
- [operator-documentation-design.md](operator-documentation-design.md) - Resolve ONNX operator schemas during parsing and expose them to both renderers. Status: proposed.
